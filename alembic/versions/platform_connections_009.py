...
def upgrade():
    op.create_table(
        ...
        # Per-link override (NULL = org-level, applies to all links)
    ...
    op.create_index('ix_platform_connections_org_id',
                    'platform_connections', ['org_id'])
    op.create_index('ix_platform_connections_org_platform',
                    'platform_connections', ['org_id', 'platform'])
